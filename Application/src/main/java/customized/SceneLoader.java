...
public class SceneLoader implements LoaderTask.Callback {
    ...
    private void makeToastText(final String text, final int toastDuration) {
        MainActivity.instance.runOnUiThread(() -> Toast.makeText(MainActivity.instance.getApplicationContext(), text, toastDuration).show());
    }
    ...
    @Override
    public void onStart(){
        ContentUtils.setThreadActivity(MainActivity.instance);
    }
